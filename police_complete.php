...
<head>
   ...
   $con=mysqli_connect("localhost","root","","crime_protal");
    ...
    $p_id=$_SESSION['pol'];
     $result=mysqli_query($con,"SELECT c_id,type_crime,d_o_c,location,mob,u_addr FROM complaint natural join user where p_id='$p_id' and pol_status='ChargeSheet Filed' order by c_id desc");
    ?>
