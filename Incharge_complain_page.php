...
<head>
   ...
   $con=mysqli_connect("localhost","root","","crime_protal");
    ...
    if($_SERVER["REQUEST_METHOD"]=="POST")
    {
        ...
        $_SESSION['cid']=$cid;
        $qu=mysqli_query($con,"select inc_status,location from complaint where c_id='$cid'");
...
<body style="background-color: #dfdfdf">
 ...
 <div style="padding:50px;">
   ...
   color: white;
   text-align: center;">
  <h4 style="color: white;">&copy <b>Final year project-Crime Portal| All Right Reserved</b></h4>
</div>
